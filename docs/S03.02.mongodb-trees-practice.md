- [S03.02  Paris Trees worksheet on MongoDB](#s0302--paris-trees-worksheet-on-mongodb)
  ...
  - [Section 3 : Schema Validation](#section-3--schema-validation)
    ...
    - [Q3.1 Write a trees validator](#q31-write-a-trees-validator)
  ...
  - [Section 4: GeoJSON](#section-4-geojson)
    ...
    - [Q4.4 covert gardens geolocation](#q44-covert-gardens-geolocation)
...
Now write the statement using `$set` and `$updateMany()` that actually adds the new field into the collection.
...
the db.trees.findOne() command should return something similar to
...
### Q4.4 covert gardens geolocation
