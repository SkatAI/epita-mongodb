- [S03.02  Paris Trees worksheet on MongoDB](#s0302--paris-trees-worksheet-on-mongodb)
  ...
  - [Section 1: load the data](#section-1-load-the-data)
    ...
    - [Now load the entire trees dataset](#now-load-the-entire-trees-dataset)
    - [And load the greenspaces dataset](#and-load-the-greenspaces-dataset)
  - [Section 2: Data Exploration](#section-2-data-exploration)
    ...
    - [Q2.3 dimensions of trees](#q23-dimensions-of-trees)
    ...
    - [Q2.9 is _perimetre_ available for all categories of greenSpaces ?](#q29-is-perimetre-available-for-all-categories-of-greenspaces-)
    - [Q2.10 Sample 5 greenSpaces at random](#q210-sample-5-greenspaces-at-random)
  - [Section 3 : validation of the dataset](#section-3--validation-of-the-dataset)
...
6. import the Green Spaces dataset into its own collection
...
### Now load the entire trees dataset
...
### And load the greenspaces dataset
...
### Q2.9 is _perimetre_ available for all categories of greenSpaces ?
...
## Section 3 : validation of the dataset
...
For that we will create the collection **before** importing the data and specify what sort of data can be added to the collection.

### Schema Validation

First please familiarize yourself with schema validation in MongoDB with this document

https://github.com/SkatAI/epita-mongodb/blob/master/docs/schema_validation.md
